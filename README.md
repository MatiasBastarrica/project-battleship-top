...
[Live version](https://matiasbastarrica.github.io/project-battleship-top/)

# Introduction

I’m going to implement the classic game ‘Battleship’. If you’ve never played it, or need a refresher, you can read about [Battleship’s rules](<https://en.wikipedia.org/wiki/Battleship_(game)>) and you can [play an online version of Battleship](http://en.battleship-game.org/).

I will make use of the Test Driven Develpment approach to develop this project.
